...
sed -i "s|^font_dir.*$|font_dir = '${copy_path}fonts/'|" data_cfg.py

sed -i "s|^standard_font_path.*$|standard_font_path = '${copy_path}fonts/NanumGothic-Regular.ttf'|" data_cfg.py
